...
export type AddCartMutation = { cartLinesAdd?: Maybe<{ cart?: Maybe<(
      Pick<Cart, 'id' | 'createdAt' | 'updatedAt'>
      & { lines: { nodes: Array<(
          Pick<CartLine, 'id'>
          & { merchandise: (
          ...
          Pick<ComponentizableCartLine, 'id'>
          & { merchandise: (
            Pick<ProductVariant, 'id' | 'title'>
            & { image?: Maybe<Pick<Image, 'id' | 'url'>> }
          ) }
        )> }, cost: { totalAmount: Pick<MoneyV2, 'amount' | 'currencyCode'>, subtotalAmount: Pick<MoneyV2, 'amount' | 'currencyCode'> } }
    )> }> };

export type GetCollectionBeforeQueryVariables = Exact<{
  handle: Scalars['String']['input'];
  last?: InputMaybe<Scalars['Int']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
}>;
...
export type GetCollectionBeforeQuery = { collection?: Maybe<(
    Pick<Collection, 'title' | 'description'>
    & { products: { nodes: Array<(
      ...
      )>, pageInfo: Pick<PageInfo, 'hasPreviousPage' | 'hasNextPage' | 'startCursor' | 'endCursor'> } }
  )> };
...
export type GetProductQuery = { product?: Maybe<(
    ...
    & { featuredImage?: Maybe<Pick<Image, 'id' | 'url'>>, selectedOrFirstAvailableVariant?: Maybe<{ selectedOptions: Array<Pick<SelectedOption, 'name' | 'value'>> }>, options: Array<(
      Pick<ProductOption, 'name'>
      & { optionValues: Array<Pick<ProductOptionValue, 'id' | 'name'>> }
    )>, variants: { nodes: Array<(
        Pick<ProductVariant, 'id' | 'availableForSale' | 'quantityAvailable'>
        & { image?: Maybe<Pick<Image, 'id' | 'url'>>, price: Pick<MoneyV2, 'amount' | 'currencyCode'>, selectedOptions: Array<Pick<SelectedOption, 'name' | 'value'>> }
      )> } }
  )> };
...
interface GeneratedMutationTypes {
  "mutation addCart($cartId: ID!, $merchandiseId: ID!, $quantity: Int = 1) {\n  cartLinesAdd(\n    cartId: $cartId\n    lines: [{quantity: $quantity, merchandiseId: $merchandiseId}]\n  ) {\n    cart {\n      id\n      createdAt\n      updatedAt\n      lines(first: 100) {\n        nodes {\n          id\n          merchandise {\n            ... on ProductVariant {\n              id\n              title\n              image {\n                id\n                url\n              }\n            }\n          }\n        }\n      }\n      cost {\n        totalAmount {\n          amount\n          currencyCode\n        }\n        subtotalAmount {\n          amount\n          currencyCode\n        }\n      }\n    }\n  }\n}": {return: AddCartMutation, variables: AddCartMutationVariables},
          ...
          declare module 'api' {
            interface Queries extends GeneratedQueryTypes {}
            interface Mutations extends GeneratedMutationTypes {}
          }
